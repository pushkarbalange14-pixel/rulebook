...
| | Technology | Role |
|---|---|---|
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" width="28" height="28" alt="HTML5"/> | **HTML5** | Page structure and markup |
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" width="28" height="28" alt="CSS3"/> | **CSS3** | Styling, CSS custom properties for theming, responsive layout |
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" width="28" height="28" alt="JavaScript"/> | **JavaScript (ES6+)** | App logic and component behavior |
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" width="28" height="28" alt="React"/> | **React 18** | UI components, loaded via CDN — no build step, no bundler |
| <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/babel/babel-original.svg" width="28" height="28" alt="Babel"/> | **Babel Standalone** | In-browser JSX transpilation |
